...
send "int Fa 4\r"
expect "*(config-if)#"
send "rate-limit 1024\r"
expect "*(config-if)#"
send "traffic-shape 2048\r"
expect "*(config-if)#"
send "exit\r"
expect "*(config)#"
...
send "int Fa 6\r"
expect "*(config-if)#"
send "no switchport trunk native vlan\r"
expect "*(config-if)#"
...
send "int Fa 3\r"
expect "*(config-if)#"
send "switchport trunk native vlan 2\r"
expect "*(config-if)#"
send "switchport forbidden default-vlan\r"
expect "*(config-if)#"
send "exit\r"
expect "*(config)#"
